...
1. Open `B-brain/brand-discovery-worksheet.md`
2. Answer the questions (10-15 minutes)
3. Copy the prompt from `T-tools/02-prompts/[your-track]/01-convert-brand-discovery.md`
...
1. **Add more writing samples** to your track folder in `B-brain/` (at least 3-5)
2. **Run Exercise 2** to teach agents your style
3. **Create your first real piece** (not a practice one)
...
2. **Not enough writing samples**
   - Add 3-5 real pieces to your track folder (e.g., `B-brain/content-samples/`)
   - Run `02-learn-my-writing-style.md` again
...
Check:
1. Are you in the right folder? (Claude should be opened in your project folder)
...
Type `/tom` and ask your question. I'll help you figure it out.
