...
If files are empty: Tell them to start with Exercise 1 (brand discovery worksheet).
...
2. **Not enough writing samples.** The agents learn your voice from your samples folder (e.g., `B-brain/content-samples/`). Add 3-5 real pieces you've written. Then run the style learning prompt again from your track folder.
...
1. Feed Your Core → `01-convert-brand-discovery.md`
2. Set Your Style → `02-learn-my-writing-style.md`
3. Sync Your Team → `03-sync-agents-with-context.md`
4. Create First Post → `04-create-linkedin-post.md`
