...
├── researcher-agent.md  → Turns questions into structured briefings
...
YOU (publish)
    ↓
The Loop (update M-memory → promote to C-core)
```

You are always the CEO. Agents execute. You decide.
